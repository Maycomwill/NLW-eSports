      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1 rounded-lg w-[480px] shadow-lg shadow-black/25'>
              ...
              <form className='mt-8 flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Input id="nickname" placeholder='Digite seu nome (ou nickname)' 
                  />
                </div>
